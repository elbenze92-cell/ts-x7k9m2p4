// ==UserScript==
// @name         Claude Automation - senior_hobby
// @namespace    http://tampermonkey.net/
// @version      2.2.2
// @description  롱폼 대본 분석 후 숏츠 생성 - 수동 다운로드 버전
// @author       You
// @match        https://claude.ai/project/019ad90b-c99e-7143-a6c6-b1a5b5245cdc
// @updateURL    https://cdn.jsdelivr.net/gh/elbenze92-cell/ts-x7k9m2p4@main/spare7.user.js
// @downloadURL  https://cdn.jsdelivr.net/gh/elbenze92-cell/ts-x7k9m2p4@main/spare7.user.js
// @grant        GM_addStyle
// @run-at       document-end
// ==/UserScript==
